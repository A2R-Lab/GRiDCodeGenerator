...
def gen_add_shared_memory_helpers(self):
    self.gen_add_code_lines([
        ...
        "#endif",
        "",
        "#ifndef GRID_CUDA_FLOATING_ABA_RECURSIVE",
        "#define GRID_CUDA_FLOATING_ABA_RECURSIVE 1",
        "#endif",
        "",
        "#ifndef GRID_CUDA_DEBUG_FLOATING_ABA",
        "#define GRID_CUDA_DEBUG_FLOATING_ABA 0",
        "#endif",
        "",
